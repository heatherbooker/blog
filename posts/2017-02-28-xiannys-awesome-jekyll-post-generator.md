...
And then, in checking out the Blaggregator feed (that I finally added myself to! \*cue emoji with monkey covering its eyes\*), I came upon Xianny's blog post where she wrote the PERFECT SCRIPT! ~~You should definitely [read it](https://journal.xianny.com/2017/02/21/autogen-jekyll-new-post.html)! Go. Right now.~~ Link is dead! :'(
